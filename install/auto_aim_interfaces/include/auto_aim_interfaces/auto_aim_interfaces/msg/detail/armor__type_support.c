...
size_t auto_aim_interfaces__msg__Armor__rosidl_typesupport_introspection_c__size_function__Armor__kpts(
...
const void * auto_aim_interfaces__msg__Armor__rosidl_typesupport_introspection_c__get_const_function__Armor__kpts(
...
void * auto_aim_interfaces__msg__Armor__rosidl_typesupport_introspection_c__get_function__Armor__kpts(
...
void auto_aim_interfaces__msg__Armor__rosidl_typesupport_introspection_c__fetch_function__Armor__kpts(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const geometry_msgs__msg__Point * item =
    ((const geometry_msgs__msg__Point *)
    auto_aim_interfaces__msg__Armor__rosidl_typesupport_introspection_c__get_const_function__Armor__kpts(untyped_member, index));
  geometry_msgs__msg__Point * value =
    (geometry_msgs__msg__Point *)(untyped_value);
  *value = *item;
}

void auto_aim_interfaces__msg__Armor__rosidl_typesupport_introspection_c__assign_function__Armor__kpts(
  void * untyped_member, size_t index, const void * untyped_value)
{
  geometry_msgs__msg__Point * item =
    ((geometry_msgs__msg__Point *)
    auto_aim_interfaces__msg__Armor__rosidl_typesupport_introspection_c__get_function__Armor__kpts(untyped_member, index));
  const geometry_msgs__msg__Point * value =
    (const geometry_msgs__msg__Point *)(untyped_value);
  *item = *value;
}

bool auto_aim_interfaces__msg__Armor__rosidl_typesupport_introspection_c__resize_function__Armor__kpts(
...
static rosidl_typesupport_introspection_c__MessageMember auto_aim_interfaces__msg__Armor__rosidl_typesupport_introspection_c__Armor_message_member_array[5] = {
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(auto_aim_interfaces__msg__Armor, kpts),  // bytes offset in struct
    NULL,  // default value
    auto_aim_interfaces__msg__Armor__rosidl_typesupport_introspection_c__size_function__Armor__kpts,  // size() function pointer
    auto_aim_interfaces__msg__Armor__rosidl_typesupport_introspection_c__get_const_function__Armor__kpts,  // get_const(index) function pointer
    auto_aim_interfaces__msg__Armor__rosidl_typesupport_introspection_c__get_function__Armor__kpts,  // get(index) function pointer
    auto_aim_interfaces__msg__Armor__rosidl_typesupport_introspection_c__fetch_function__Armor__kpts,  // fetch(index, &value) function pointer
    auto_aim_interfaces__msg__Armor__rosidl_typesupport_introspection_c__assign_function__Armor__kpts,  // assign(index, value) function pointer
    auto_aim_interfaces__msg__Armor__rosidl_typesupport_introspection_c__resize_function__Armor__kpts  // resize(index) function pointer
  }
};
