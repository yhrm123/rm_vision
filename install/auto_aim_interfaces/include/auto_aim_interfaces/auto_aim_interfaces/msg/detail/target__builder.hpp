...
class Init_Target_pitch
{
public:
  explicit Init_Target_pitch(::auto_aim_interfaces::msg::Target & msg)
  : msg_(msg)
  {}
  Init_Target_yaw pitch(::auto_aim_interfaces::msg::Target::_pitch_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_Target_pitch velocity(::auto_aim_interfaces::msg::Target::_velocity_type arg)
  {
    msg_.velocity = std::move(arg);
    return Init_Target_pitch(msg_);
  }
