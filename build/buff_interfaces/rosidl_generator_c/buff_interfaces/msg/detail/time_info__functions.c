...
buff_interfaces__msg__TimeInfo__init(buff_interfaces__msg__TimeInfo * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    buff_interfaces__msg__TimeInfo__fini(msg);
    return false;
  }
  // time
  return true;
...
buff_interfaces__msg__TimeInfo__create()
{
  ...
  buff_interfaces__msg__TimeInfo * msg = (buff_interfaces__msg__TimeInfo *)allocator.allocate(sizeof(buff_interfaces__msg__TimeInfo), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(buff_interfaces__msg__TimeInfo));
  bool success = buff_interfaces__msg__TimeInfo__init(msg);
  if (!success) {
...
buff_interfaces__msg__TimeInfo__Sequence__init(buff_interfaces__msg__TimeInfo__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  buff_interfaces__msg__TimeInfo * data = NULL;

  if (size) {
    data = (buff_interfaces__msg__TimeInfo *)allocator.zero_allocate(size, sizeof(buff_interfaces__msg__TimeInfo), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = buff_interfaces__msg__TimeInfo__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        buff_interfaces__msg__TimeInfo__fini(&data[i - 1]);
      }
...
buff_interfaces__msg__TimeInfo__Sequence__fini(buff_interfaces__msg__TimeInfo__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      buff_interfaces__msg__TimeInfo__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  buff_interfaces__msg__TimeInfo__Sequence * array = (buff_interfaces__msg__TimeInfo__Sequence *)allocator.allocate(sizeof(buff_interfaces__msg__TimeInfo__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = buff_interfaces__msg__TimeInfo__Sequence__init(array, size);
  if (!success) {
...
buff_interfaces__msg__TimeInfo__Sequence__destroy(buff_interfaces__msg__TimeInfo__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    buff_interfaces__msg__TimeInfo__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
buff_interfaces__msg__TimeInfo__Sequence__are_equal(const buff_interfaces__msg__TimeInfo__Sequence * lhs, const buff_interfaces__msg__TimeInfo__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!buff_interfaces__msg__TimeInfo__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  buff_interfaces__msg__TimeInfo__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(buff_interfaces__msg__TimeInfo);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    buff_interfaces__msg__TimeInfo * data =
      (buff_interfaces__msg__TimeInfo *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!buff_interfaces__msg__TimeInfo__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          buff_interfaces__msg__TimeInfo__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!buff_interfaces__msg__TimeInfo__copy(
