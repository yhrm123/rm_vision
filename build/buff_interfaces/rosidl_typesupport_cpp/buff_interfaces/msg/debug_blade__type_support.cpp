...
static const _DebugBlade_type_support_symbol_names_t _DebugBlade_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, buff_interfaces, msg, DebugBlade)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, buff_interfaces, msg, DebugBlade)),
  }
};
...
{
  return &::buff_interfaces::msg::rosidl_typesupport_cpp::DebugBlade_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, buff_interfaces, msg, DebugBlade)() {
  return get_message_type_support_handle<buff_interfaces::msg::DebugBlade>();
}
