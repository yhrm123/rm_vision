...
static const _Blade_type_support_symbol_names_t _Blade_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, buff_interfaces, msg, Blade)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, buff_interfaces, msg, Blade)),
  }
};
...
{
  return &::buff_interfaces::msg::rosidl_typesupport_cpp::Blade_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, buff_interfaces, msg, Blade)() {
  return get_message_type_support_handle<buff_interfaces::msg::Blade>();
}
